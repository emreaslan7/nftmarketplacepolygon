    ...
    async function createItem() {
      ...
      return (
        <div className="flex justify-center">
          <div className="w-1/2 flex flex-col pb-12  text-gray-800 mt-32">
            <input 
            ...
            }
            {
              loading == "loaded" ? (
                ...
                <button disabled type="button" className="text-white bg-pink-700 hover:bg-pink-700 font-bold rounded shadow-lg p-4 text-center mt-4">
